...
(function ($) {
    ...
    if ($slimScrolls.length > 0) {
        $slimScrolls.slimScroll({
            height: 'auto', width: '100%', position: 'right', size: '7px', color: '#ccc',
            allowPageScroll: false, wheelStep: 10, touchScrollStep: 100
        });
    ...
    $(document).on('click', '.mail-important', function () { $(this).find('i.fa').toggleClass('fa-star fa-star-o'); });
    ...
    // remove document-level anti-inspection handlers; DO NOT add them back.
    // (Previously the original script set document.onkeydown and document.oncontextmenu to block devtools.)
